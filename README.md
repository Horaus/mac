...
##### Có gì mới trong phiên bản 0.5.3
...
Hotfix 0.5.3 sửa kết quả `result_only` để chỉ trả task được hỏi, giữ checkpoint
...
Version 0.5.3 also adds free-tier API routing for Google Gemini and Cloudflare
...
The 0.5.3 hotfix makes `result_only` truly task-scoped, preserves explicit
